 ...
 */
class Ingredientes extends \Gestor_cocina\RecetasBundle\Entity\Ingredientes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'receta', 'producto', 'cantidad');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ingredientes $proxy) {
