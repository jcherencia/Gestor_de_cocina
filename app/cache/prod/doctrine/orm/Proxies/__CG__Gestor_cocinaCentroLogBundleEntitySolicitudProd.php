...
namespace Proxies\__CG__\Gestor_cocina\CentroLogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class SolicitudProd extends \Gestor_cocina\CentroLogBundle\Entity\SolicitudProd implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Gestor_cocina\\CentroLogBundle\\Entity\\SolicitudProd' . "\0" . 'id', 'producto', '' . "\0" . 'Gestor_cocina\\CentroLogBundle\\Entity\\SolicitudProd' . "\0" . 'cantidad', '' . "\0" . 'Gestor_cocina\\CentroLogBundle\\Entity\\SolicitudProd' . "\0" . 'prodsustraido', '' . "\0" . 'Gestor_cocina\\CentroLogBundle\\Entity\\SolicitudProd' . "\0" . 'usuario', '' . "\0" . 'Gestor_cocina\\CentroLogBundle\\Entity\\SolicitudProd' . "\0" . 'fecha');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SolicitudProd $proxy) {
    ...
    public function setProdsustraido($prodsustraido)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProdsustraido', array($prodsustraido));

        return parent::setProdsustraido($prodsustraido);
    }
    ...
    public function getProdsustraido()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProdsustraido', array());

        return parent::getProdsustraido();
    }
