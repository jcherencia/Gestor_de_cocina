 ...
 */
class Recetas extends \Gestor_cocina\RecetasBundle\Entity\Recetas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Recetas $proxy) {
    ...
    public function setComensales($comensales)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setComensales', array($comensales));
    ...
    public function getComensales()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getComensales', array());
