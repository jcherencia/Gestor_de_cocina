 ...
 */
class Categoria extends \Gestor_cocina\RecetasBundle\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Gestor_cocina\\RecetasBundle\\Entity\\Categoria' . "\0" . 'id', '' . "\0" . 'Gestor_cocina\\RecetasBundle\\Entity\\Categoria' . "\0" . 'nombre');
        }
